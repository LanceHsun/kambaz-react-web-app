                  ...
                  >
                    ...
                    <div className="wd-assignment-text flex-grow-1">
                      {currentUser.role === "FACULTY" ? (
                        ...
                        <span className="wd-assignment-name">
                          {assignment.title}
                        </span>
                      )}
                      <label className="wd-assignment-description">
                        <span className="text-danger"> Multiple Modules </span> | 
                        <span className="wd-bold"> Not available until </span> 
                        {formatDate(assignment.available_dt)} | 
                        <span className="wd-bold"> Due </span> 
                        {formatDate(assignment.due_dt)} | 
